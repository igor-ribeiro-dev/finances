...
| 008 | Budget & Expense Dashboard | A summary view for the current calendar month showing: total spent vs. family budget, each member's spending vs. their individual monthly budget, and a category breakdown with percentages. All expenses — including those paid by credit card — count toward spending totals on the dashboard. | Planned | 007 |
